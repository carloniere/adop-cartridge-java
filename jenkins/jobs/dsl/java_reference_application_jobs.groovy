...
def referenceAppGitUrl = "git@gitlab:PDC_Security_HackathonFY17/spring-petclinic.git"
def regressionTestGitUrl = "git@gitlab:PDC_Security_HackathonFY17/adop-cartridge-java-regression-tests.git"
